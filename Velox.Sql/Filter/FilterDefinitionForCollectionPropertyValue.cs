...
{
    public sealed class FilterDefinitionForCollectionPropertyValue<FilteredClass, CollectionProperty, MemberValue> : IFilter<FilteredClass>
    {
        ...
        public Expression<Func<FilteredClass, bool>> GetFilterPredicateFor(FilterOperations operation, string value)
        {
            ...
            var method = typeof(Enumerable).GetMethods()
                ...
                .Single().MakeGenericMethod(typeof(CollectionProperty));

            var outerLambda = Expression.Call(method, Expression
                .Property(collectionParameter, (CollectionSelector.Body as MemberExpression).Member as System.Reflection.PropertyInfo)
                , innerFunction);
